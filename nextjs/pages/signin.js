      ...
      <>
        <div className="flex justify-center pt-20 pb-20">
          <div className="w-1/2 rounded-[25px] bg-white mb-6 mt-10">
            <p className="text-3xl text-center text-gray-700 font-bold">Sign In</p>
            <form
            ...
            >
              <div className="flex flex-col">
                ...
                <div className="pb-6 flex justify-between">
                  <span onClick={() => router.push('/signup')} className="hover:cursor-pointer text-blue-500 mr-3 pt-4 mt-4 w-full h-14 font-semibold text-base">
                    Sign Up Here
                  </span>
